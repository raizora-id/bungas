...
import { ChevronDownIcon, ChevronUpIcon, MinusIcon } from 'npm:lucide-react';
...
export const PillAvatar = ({
  ...
  <Avatar className={cn('-ml-1 h-4 w-4', className)} {...props}>
    <AvatarImage />
...
export const PillIndicator = ({
  ...
  pulse = false,
  ...props
}: PillIndicatorProps & React.HTMLAttributes<HTMLSpanElement>) => (
